...
export var encrypt = function encrypt(inArray, key, options) {
  return sm4(inArray, key, 1, options);
};
export var decrypt = function decrypt(inArray, key, options) {
  return sm4(inArray, key, 0, options);
};
export var encryptBase64 = function encryptBase64(inArray, key, options) {
  return sm4(inArray, key, 1, options, 1);
};
export var decryptBase64 = function decryptBase64(inArray, key, options) {
  return sm4(inArray, key, 0, options, 1);
};