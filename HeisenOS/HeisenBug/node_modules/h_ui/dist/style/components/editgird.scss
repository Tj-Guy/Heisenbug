...
.#{$editgird-prefix-cls} {
  ...
  &-footer {
    @if $--size-switch == yes {
      line-height: computed-table-th-height(normal);
  ...
  th.#{$editgird-prefix-cls}-cell-overflow-visible,
  td.#{$editgird-prefix-cls}-cell-overflow-visible
  {
  ...
  .edit-grid-input:not(.edit-grid-texarea){
    height: auto;
    line-height: 0;
  }
  ...
  &-large {
    ...
    td {
     ...
     // asycTreeGird样式，其他没有
     .#{$editgird-prefix-cls}-title,
     .#{$editgird-prefix-cls}-footer {
      @if $--size-switch == yes {
        line-height: computed-table-th-height(large);
        height: computed-table-th-height(large);
      }
    }
  }
  ...
  &-small {
    ...
    .#{$editgird-prefix-cls}-footer {
     @if $--size-switch == yes {
       line-height: computed-table-td-height(small);
       height: computed-table-td-height(small);
     }
   }
  }
