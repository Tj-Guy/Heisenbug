...
var _Symbol$iterator = __webpack_require__(57);
...
var _getPrototypeOf = _interopRequireDefault(__webpack_require__(70));

var _zhCN = _interopRequireDefault(__webpack_require__(74));

var _vue = _interopRequireDefault(__webpack_require__(75));

var _deepmerge = _interopRequireDefault(__webpack_require__(80));

var _format = _interopRequireDefault(__webpack_require__(0));
...
var i18nHandler = function i18nHandler() {
  var vuei18n = (0, _getPrototypeOf.default)(this || _vue.default).$t;

  if (typeof vuei18n === 'function' && typeof _vue.default.locale === 'function') {
    if (!merged) {
      merged = true;
...
var _default = {
  i: {
    ...
    validatorMsg: {
      ...
      qq: 'QQ号码格式不正确',
      tel: '电话号码格式不正确',
      username: '只能输入由数字、26个英文字母或者下划线组成的字符串',
      letter: '只能输入字母格式',
      letter_u: '只能输入大写字母格式',
      letter_l: '只能输入小写字母格式'
    },
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(76), __webpack_require__(77).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(76), __webpack_require__(79)))
